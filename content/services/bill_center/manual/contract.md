...
当您想要对 云平台订购的产品进行报销等操作时，可以申请开具合同。申请合同中填写的公司（或个人）视为实际交易的法律主体。合同开具成功后，您可以直接在控制台上下载电子合同。
...
- 框架合同
  ...
  服务协议：是由云计算服务网站的所有及运营方与用户就提供且用户使用的云计算服务而签订的对双方具有约束力的协议。
...
2. 系统会根据您保存的甲方信息自动填充甲方信息。
   ...
   甲方名称必须与您在云平台实名认证的信息保持一致。若需要修改甲方名称，请先修改实名认证信息。详细操作请参见[修改实名认证信息](/authorization/account/manual/user_verify/#修改实名认证信息)。
